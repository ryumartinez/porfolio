        ...
        <h3 className="text-3xl py-1">Portfolio</h3>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
             ...
             <div className="basis-1/3 flex-1 ">
              <Image src={web2} alt="web1" className="rounded-lg object-cover w-full h-full"/>
            </div>
             <div className="basis-1/3 flex-1 ">
              <Image src={web3} alt="web1" className="rounded-lg object-cover w-full h-full"/>
            </div>
             <div className="basis-1/3 flex-1 ">
              <Image src={web4} alt="web1" className="rounded-lg object-cover w-full h-full"/>
            </div>
             <div className="basis-1/3 flex-1 ">
              <Image src={web5} alt="web1" className="rounded-lg object-cover w-full h-full"/>
            </div>
             <div className="basis-1/3 flex-1 ">
              <Image src={web6} alt="web1" className="rounded-lg object-cover w-full h-full"/>
            </div>
